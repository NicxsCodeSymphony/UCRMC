...
<form method="POST" action="updateStudent.php" enctype="multipart/form-data">
    ...
    <div class="main-content">
        ...
        <input style="margin-left: 22%;" id="birthdate" type="date" onchange="calculateAge()" name="birthdate" value="<?= $student['birthdate'] ?>">
    </div>
    <div class="container">
        <label for="">Age:</label>
        <input style="margin-left: 30%;" type="number" id="age" name="age" value="<?= $student['age'] ?>">
    </div>

    <div class="container">
        <label for="">Email:</label>
        <input style="margin-left: 27%;" type="text" name="email" value="<?= $student['email'] ?>">
    </div>
    ...
    <div class="container">
        ...
        <input style="margin-left: 10%;" type="text" name="contact" value="<?= $student['contact'] ?>">
    </div>

    <div class="container">
        <label for="">Address:</label>
        <input style="margin-left: 23%;" type="text" name="address" value="<?= $student['address'] ?>">
    </div>
