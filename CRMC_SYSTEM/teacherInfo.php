...
include 'php/teacherCommands.php';
?>
...
<button class="button" type="button" onclick="gotoSignup()">
    ...
    <span class="button__icon"><svg class="svg" fill="none" height="24" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><line x1="12" x2="12" y1="5" y2="19"></line><line x1="5" x2="19" y1="12" y2="12"></line></svg></span>
        ...
        <div class="table-container">
           ...
           <div class="left-head">
    <h1 style="font-size: 2.2rem;">Teacher</h1>
            ...
            <?php foreach ($departments as $department): ?>
                <tr>
                    ...
                    <td>
                        ...
                        <?php if (!empty($department['photo'])): ?>
                            <img src="<?= $department['photo']; ?>" alt="Department Logo" style="width: 50px; height: 50px;">
                        <?php endif; ?>
                    </td>
                    <td><?= $department['birthdate'];?></td>
                    <td><?= $department['age'];?></td>
                    <td><?= $department['email'];?></td>
                    <td><?= $department['password'];?></td>
                    <td><?= $department['contact'];?></td>
                  <td><?= str_replace('Bogo City, Cebu', '', $department['address']); ?></td>
                    <td><?= ($department['departmentName'] == 'College of Computer Studies') ? 'CCS' : $department['departmentName']; ?></td>
                        <input type="hidden" name="" value="<?= $departmentID['teacherID']?>">
                    <!-- Add other columns as needed -->

                    <!-- Add action buttons for update and delete -->
                    <td>
                                        <a href="updateTeacher.php?teacherID=<?= $department['teacherID']; ?>">Update</a>
                        <button onclick="deleteDepartment(<?= $department['teacherID']; ?>)">Delete</button>
                    </td>
                </tr>
            <?php endforeach; ?>
        <?php else: ?>
...
function deleteDepartment(departmentID) {
        if (confirm("Are you sure you want to delete this department?")) {
            ...
            xhr.send("teacherID=" + departmentID);
        }
    }
